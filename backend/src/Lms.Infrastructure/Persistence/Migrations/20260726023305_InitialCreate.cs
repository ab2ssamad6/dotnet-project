        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Attachment = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AiAvatarEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    TrainingId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Activities_AssessmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_ModuleId_Order",
                table: "Activities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_StudentId_TrainingId",
                table: "Enrollments",
                columns: new[] { "StudentId", "TrainingId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleCompletions_EnrollmentId_ModuleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Modules_TrainingId_Order",
                table: "Modules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_EnrollmentId_ActivityId",
                table: "QuizAttempts",
                columns: new[] { "EnrollmentId", "ActivityId" });
